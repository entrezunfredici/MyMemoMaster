...
// Permet d'injecter une config au runtime via le service front_server du docker-compose (window.__APP_CONFIG__)
...
const fallbackApiUrl = import.meta.env.VITE_API_URL || 'http://localhost/api/v1';

<template>
  <div class="flex h-screen w-full contenue">
    <div class="hidden md:block w-[70%] h-full bg-blue-500 custom-border">
      <img src="../../../public/inscription.png" alt="Inscription" class="w-full h-full object-cover imageConnexion">
    </div>

    <div class="w-full md:w-[30%] flex flex-col justify-center items-center bg-white px-8 md:px-16 border custom-border formulaire">

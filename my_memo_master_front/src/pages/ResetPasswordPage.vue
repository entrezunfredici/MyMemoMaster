<template>
  <div class="flex h-screen w-full bg-primary rounded-[50px]">
    ...
    <div class="w-full md:w-[30%] flex flex-col justify-center items-center bg-white px-8 md:px-16 border border-[#1E3BA1] custom-border formulaire">
      ...
      <h2 class="text-primary text-[2rem] md:text-[2.5rem] font-bold text-center">Nouveau mot de passe</h2>
      <p class="text-gray-500 text-sm text-center mt-2 mb-6">Collez le token reçu par email et choisissez un nouveau mot de passe.</p>

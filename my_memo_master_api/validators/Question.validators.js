...
exports.create = [
    ...
    body('questionPosition').isInt({ min: 0 }).withMessage('questionPosition doit être un entier positif ou nul'),
    ...
    body('idCard').optional({ nullable: true }).isInt({ min: 1 }).withMessage('idCard doit être un entier positif'),
...
exports.update = [
    ...
    body('questionPosition').optional().isInt({ min: 0 }).withMessage('questionPosition doit être un entier positif ou nul'),

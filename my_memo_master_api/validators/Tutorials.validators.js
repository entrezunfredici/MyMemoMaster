...
exports.create = [
    body('name').trim().notEmpty().withMessage('Le nom du tutoriel est requis').isLength({ max: 200 }),
    body('link').trim().notEmpty().withMessage('Le lien est requis').isURL().withMessage('Le lien doit être une URL valide'),

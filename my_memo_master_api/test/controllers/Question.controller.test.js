...
const mockQuestion = { idQuestion: 1, statement: 'Quelle est la capitale ?', questionPosition: 1, type: 'open' };
...
describe('Question Controller', () => {
  ...
  describe('PUT /questions/edit/:id', () => {
    it('200 — met à jour la question', async () => {
      questionService.update.mockResolvedValue({ ...mockQuestion, statement: 'Question modifiée ?' });

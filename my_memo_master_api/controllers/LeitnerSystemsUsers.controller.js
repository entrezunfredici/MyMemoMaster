...
module.exports = {
  async create(req, res) {
    try {
      const { idSystem, writeRight, shareRight, shareWithWriteRightRight, shareWithAllRights } =
        req.body
  ...
  async update(req, res) {
    try {
      ...
      const result = await LeitnerSystemsUsersService.update(idUser, idSystem, data)

...
class GradingService {
  ...
  parseDateSafe(dateString) {
    ...
    const hasDatePattern = /\b(0?[1-9]|1[0-2])\b|[1-3]?[0-9](st|nd|rd|th)?|er\b|\b(jan|feb|mar|apr|may|jun|jul|aug|sep|oct|nov|dec|janvier|février|mars|avril|mai|juin|juillet|août|septembre|octobre|novembre|décembre)\b|\/|-/i.test(normalized);
  ...
  gradeDateAnswer(correctAnswer, studentAnswer) {
    ...
    if (correctParsed && studentParsed && correctParsed.month === null && studentParsed.month === null) {

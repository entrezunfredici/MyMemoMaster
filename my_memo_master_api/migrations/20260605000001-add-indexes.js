...
module.exports = {
  async up(queryInterface) {
    ...
    await queryInterface.addIndex("LeitnerCard", ["idQuestion"], { name: "idx_leitnercard_idquestion" });
    await queryInterface.addIndex("LeitnerCard", ["idBox"], { name: "idx_leitnercard_idbox" });
    await queryInterface.addIndex("LeitnerCard", ["next_review_at"], { name: "idx_leitnercard_next_review_at" });
